...
<?php
  ...
  function omni_magazine_form_system_theme_settings_alter(&$form, $form_state) {
    ...
    $form['omni_settings']['omni_breadcrumb'] = array(
      '#type'          => 'select',
      '#title'         => t('Display breadcrumb?'),
      '#default_value' => theme_get_setting('omni_breadcrumb'),
      '#options'       => array(
        'yes'   => t('Yes'),
        'no'    => t('No'),
      ),
