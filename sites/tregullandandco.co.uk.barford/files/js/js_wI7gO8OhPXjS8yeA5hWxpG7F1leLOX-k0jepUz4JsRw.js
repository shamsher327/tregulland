...
jq8 (document).ready(function() {  
  		 jq8(".carousel-inner").swiperight(function() {  
    		  jq8(this).parent().carousel('prev');  
	    		});  
		   jq8(".carousel-inner").swipeleft(function() {  
		     jq8(this).parent().carousel('next');  
	   });  
	    }); 
	...
	var jq9 = jQuery.noConflict();
      jq9 (document).ready(function() {  
	   ...
	   jq9(".mm-title").click(function() { 

	   	/*
		jq9('#off-canvas').removeClass('mm-opened');
		//jq9('html').removeClass('mm-next');
        //jq9('html').removeClass('mm-blocking');
        //jq9('html').removeClass('mm-background');
        //jq9('html').removeClass('mm-theme-dark');
        jq9('html').removeClass('mm-opening');
        jq9('html').removeClass('mm-opened');
        //jq9('html').removeClass('mm-effect-slide-menu');
		jq9('#mm-0').css('min-height','0');*/

		jq9("#off-canvas").data( "mmenu" ).close();
	...
	jq9(function () {
		jq9(window).scroll(function () {
			if (jq9(this).scrollTop() > 200) {
				jq9('#back-top').fadeIn();
			} else {
				jq9('#back-top').fadeOut();
			}
		});

		// scroll body to 0px on click
		jq9('#back-top a').click(function () {
			jq9('body,html').animate({
				scrollTop: 0
			}, 800);
			return false;
		});
		
		jq9('.dropdown-toggle').removeAttr('data-toggle');
...
;( function ( document, window, index )
{
	...
	var tabletPortraitWidth = 991;

	var elSelector	= '.PageHeader',
	...
	window.addEventListener( 'scroll', function()
	{
		...
		else if( wScrollDiff < 0 && window.innerWidth <= tabletPortraitWidth) // scrolled down
		{
